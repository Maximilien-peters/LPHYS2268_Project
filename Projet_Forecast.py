...
def plot_time_series(trend_start_year, trend_end_year):#aurguments uniquments utiles à l'affichage de la trend selon la période désirée
    ...
    ax.plot(dates_sept[trend_start_year-1979:trend_end_year+1-1979], Y)
    ax.set_title('September SIE prediction 1979-2022')
...
def Video_time_series(): 
    ...
    def update(n):
        ...
        plt.plot(array_x, array_y1, color = "tab:blue")
        plt.plot(array_x, array_y2, color = "tab:orange")
    ...
    plt.title("September SIE prediction 1979-2022")
